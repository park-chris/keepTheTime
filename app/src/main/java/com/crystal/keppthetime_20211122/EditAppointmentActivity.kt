...
import com.crystal.keppthetime_20211122.adapters.PlaceSelectRecyclerAdapter
...
//                        커스텀뷰의 내용 : RecyclerView를 내용물로. => 장소 목록 띄우기.
                        ...
                        val customView = LayoutInflater.from(mContext)
                            .inflate(R.layout.my_custom_alert_place, null)
...
//                                실제 기능 : 장소를 선택한 곳으로 지정하기.

                                    setPlaceDataToNaverMap(data)

//                                추가 기능 : 열려있는 (show로 나타난) 팝업창 닫기 => dialog 변수에 담긴 화면 닫기.
